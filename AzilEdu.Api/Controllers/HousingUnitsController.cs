...
public class HousingUnitsController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<HousingUnitDto>> CreateHousingUnit(HousingUnitDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateHousingUnit(int id, HousingUnitDto dto)
    {
        var unit = await _context.HousingUnits.FindAsync(id);
